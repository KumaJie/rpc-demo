...
const (
	AuthService_AuthGen_FullMethodName      = "/proto.auth.AuthService/AuthGen"
	AuthService_Authenticate_FullMethodName = "/proto.auth.AuthService/Authenticate"
)
...
func (c *authServiceClient) AuthGen(ctx context.Context, in *AuthGenRequest, opts ...grpc.CallOption) (*AuthGenResponse, error) {
	out := new(AuthGenResponse)
	err := c.cc.Invoke(ctx, AuthService_AuthGen_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_AuthGen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthGenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).AuthGen(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthGen_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthGen(ctx, req.(*AuthGenRequest))
	}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AuthGen",
			Handler:    _AuthService_AuthGen_Handler,
		},
		{
